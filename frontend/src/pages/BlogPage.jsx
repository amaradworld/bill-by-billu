...
import { Calendar, Clock, ArrowRight, Tag, Search, BookOpen, TrendingUp, FileText, Lightbulb } from 'lucide-react';
    ...
    <>
      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-12 pb-20">
          <h2 className="text-xl font-bold text-gray-900 mb-6">{selectedCategory === 'All' ? 'All Articles' : selectedCategory}</h2>
