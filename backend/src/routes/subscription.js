...
const PLANS = {
  ...
  GROWTH: { name: 'Growth', price: 399, monthlyPrice: 399, yearlyPrice: 3783, invoices: 1000, features: ['1,000 invoices/month', 'AI invoice creation', 'AI business insights', 'Payment reminders', 'Multi-user access', 'Priority support'] },
